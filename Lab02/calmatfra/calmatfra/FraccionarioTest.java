...
public class FraccionarioTest {
    ...
    public void deberiaDarseCuentaQueUnFraccionarioEsIgualAElMismo () {
        ...
        Fraccionario fr1= new Fraccionario (0);
        Fraccionario fr2= new Fraccionario (0);
        assertEquals(fr1.numerador(),fr2.numerador());
        assertEquals(fr1.denominador(),fr2.denominador());
        //assertEquals(new Fraccionario (1234),new Fraccionario (1234));
        Fraccionario fr3= new Fraccionario (1234);
        Fraccionario fr4= new Fraccionario (1234);
        assertEquals(fr3.numerador(),fr4.numerador());
        assertEquals(fr3.denominador(),fr4.denominador());
        //assertEquals (new Fraccionario(5405400,4158000), new Fraccionario(5405400,4158000));
        Fraccionario fr5= new Fraccionario (5405400,4158000);
        Fraccionario fr6= new Fraccionario (5405400,4158000);
        assertEquals(fr5.numerador(),fr6.numerador());
        assertEquals(fr5.denominador(),fr6.denominador());
    }
    ...
    public void deberiaDarseCuentaSiDosFraccionariosSonIgualesConNegativos () {
        ...
        assertEquals(fr1.denominador(),fr2.denominador());
        //assertEquals(new Fraccionario(-3,100), new Fraccionario(3,-100));
        Fraccionario fr3= new Fraccionario (-3,100);
        Fraccionario fr4= new Fraccionario (3,-100);
        assertEquals(fr3.numerador(),fr4.numerador());
        assertEquals(fr3.denominador(),fr4.denominador());
    }
    ...
    public void deberiaDarseCuentaSiDosFraccionariosCreadosDistintosSonIguales () {
        ...
        Fraccionario fr1= new Fraccionario(5405400,4158000);
        Fraccionario fr2= new Fraccionario(54054,41580);
        assertEquals(fr1.numerador(),fr2.numerador());
        assertEquals(fr1.denominador(),fr2.denominador());
        //assertEquals (new Fraccionario(13,10), new Fraccionario(54054,41580));
        Fraccionario fr3= new Fraccionario(13,10);
        Fraccionario fr4= new Fraccionario(54054,41580);
        assertEquals(fr3.numerador(),fr4.numerador());
        assertEquals(fr3.denominador(),fr4.denominador());
    }
    ...
    public void deberiaDarseCuentaQueCualquieFraccionarioConNumeradorCeroEsIgual () {
        ...
        Fraccionario fr1= new Fraccionario(0,4158000);
        Fraccionario fr2= new Fraccionario(0,1);
        assertEquals(fr1.numerador(),fr2.numerador());
        assertEquals(fr1.denominador(),fr2.denominador());
        //assertEquals (new Fraccionario(0,-10), new Fraccionario(0));
        Fraccionario fr3= new Fraccionario(0,-10);
        Fraccionario fr4= new Fraccionario(0);
        assertEquals(fr3.numerador(),fr4.numerador());
        assertEquals(fr3.denominador(),fr4.denominador());
    }
    ...
    public void deberiaFallar(){
        assertEquals(new Fraccionario(3,2),new Fraccionario(1,2));
    }
    @Test
    public void deberiaErrar(){
        Fraccionario fr1 = new Fraccionario(1,2);
        assertEquals(10,fr1.divida(new Fraccionario(0,0)));
    }

    //Pruebas de sume()
    @Test
    public void deberiaSumarBien(){
        Fraccionario fraccion1 = new Fraccionario(10);
        assertEquals("20/1", fraccion1.sume(new Fraccionario(10)).toString());
    }
    @Test
    public void deberiaRestar(){
        Fraccionario fraccion1 = new Fraccionario(3, 2);
        assertEquals("1/1", fraccion1.sume(new Fraccionario(-1,2)).toString());
    }
    //Pruebas multiplique()
    @Test
    public void multiplicaBien(){
        Fraccionario fraccion2 = new Fraccionario(20, 10);
        assertEquals("3/1", fraccion2.multiplique(new Fraccionario(3,2)).toString());
    }
    //Pruebas divida()
    @Test
    public void divideBien(){
        Fraccionario fraccion1 = new Fraccionario(10);
        assertEquals("5/1", fraccion1.divida(new Fraccionario(2)).toString());
    }
